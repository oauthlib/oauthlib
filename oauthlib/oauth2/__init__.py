...
from .draft_ietf13.endpoints import CodeEndpoint
from .draft_ietf13.endpoints import VerificationEndpoint
...
from .rfc6749.endpoints import DeviceApplicationServer
