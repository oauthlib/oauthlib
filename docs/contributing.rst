...
Before you do anything else, login/signup on GitHub and fork OAuthLib from the `GitHub project`_.
...
or for consideration of merging into the project you must first push your local topic branch back up to GitHub::
...
#. If you are adding a new module don't '*cleanup*' other modules. That cleanup belongs in another pull request.
